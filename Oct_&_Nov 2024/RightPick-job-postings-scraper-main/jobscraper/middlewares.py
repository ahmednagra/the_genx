...
## https://scrapeops.io/docs/proxy-aggregator/integration-examples/python-scrapy-example/#basic-request-wrapper
...
class UserAgentLoggerMiddleware:
    def process_request(self, request, spider):
        spider.logger.info(f'🫵 User-Agent: {request.headers.get("User-Agent")}')
